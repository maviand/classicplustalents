...
exports.CHANGELOG = exports.WARLOCK_DESTRO_TALENTS = exports.WARLOCK_DEMO_TALENTS = exports.WARLOCK_AFFLICTION_TALENTS = void 0;
exports.WARLOCK_AFFLICTION_TALENTS = [
    // Tier 1
    {
        id: "suppression",
        name: "Suppression",
...
exports.WARLOCK_DESTRO_TALENTS = [
    // Tier 1
    {
        id: "bane",
        name: "Bane",

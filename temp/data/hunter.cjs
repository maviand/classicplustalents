...
exports.CHANGELOG = exports.HUNTER_SURVIVAL_TALENTS = exports.HUNTER_MM_TALENTS = exports.HUNTER_BM_TALENTS = void 0;
exports.HUNTER_BM_TALENTS = [
    // Tier 1
    { id: 'imp_aspect_hawk', name: 'Improved Aspect of the Hawk', icon: 'spell_nature_ravenform', maxPoints: 3, row: 0, col: 1, desc: ["Gives your normal ranged attacks a 10% chance to increase ranged attack speed by 30% for 12 seconds.", "20%", "30%"] },
    { id: 'endurance_training', name: 'Endurance Training', icon: 'spell_nature_reincarnation', maxPoints: 5, row: 0, col: 2, desc: ["Increases the Health of your pets by 2%.", "4%", "6%", "8%", "10%"] },
    { id: 'thick_hide', name: 'Thick Hide', icon: 'inv_misc_pelt_bear_03', maxPoints: 2, row: 0, col: 0, desc: ["Increases the armor rating of your pets by 10% and your armor contribution from items by 5%.", "20% / 10%"] },
    // Tier 2
    { id: 'focused_fire', name: 'Focused Fire', icon: 'ability_hunter_sickem', maxPoints: 3, row: 1, col: 0, desc: ["All damage caused by you is increased by 1% while your pet is active, and the critical strike chance of your pet's basic attacks is increased by 5%.", "2% / 10%", "3% / 15%"] },
    { id: 'imp_revive_pet', name: 'Improved Revive Pet', icon: 'ability_hunter_beastsoothe', maxPoints: 2, row: 1, col: 1, desc: ["Reduces the casting time of your Revive Pet spell by 3 seconds, reduces the Focus cost by 25%, and increases the health your pet returns with by 15%.", "6 sec / 50% / 30%"] },
    { id: 'bestial_discipline', name: 'Bestial Discipline', icon: 'spell_nature_abolishmagic', maxPoints: 3, row: 1, col: 2, desc: ["Increases the Focus regeneration of your pets by 10%.", "20%", "30%"] },
    { id: 'pathfinding', name: 'Pathfinding', icon: 'ability_mount_jungletiger', maxPoints: 2, row: 1, col: 3, desc: ["Increases the speed bonus of your Aspect of the Cheetah and Aspect of the Pack by 4%.", "8%"] },
    // Tier 3
    { id: 'intimidation', name: 'Intimidation', icon: 'ability_devour', maxPoints: 1, row: 2, col: 1, desc: ["Command your pet to intimidate the target on the next successful melee attack, causing a high amount of threat and stunning the target for 3 seconds. 1 minute cooldown."] },
    { id: 'unleashed_fury', name: 'Unleashed Fury', icon: 'ability_bullrush', maxPoints: 5, row: 2, col: 0, desc: ["Increases the damage done by your pets by 4%.", "8%", "12%", "16%", "20%"] },
    { id: 'ferocity', name: 'Ferocity', icon: 'inv_misc_monsterclaw_04', maxPoints: 2, row: 2, col: 2, desc: ["Increases the critical strike chance of your pets by 5%.", "10%"] },
    // Tier 4
    ...
    { id: 'animal_handler', name: 'Animal Handler', icon: 'ability_hunter_animalhandler', maxPoints: 2, row: 3, col: 0, desc: ["Increases your pet's chance to hit by 3% and reduces the cooldown of your Master's Call by 10 seconds.", "6% / 20 sec"] },
    { id: 'longevity', name: 'Longevity', icon: 'ability_hunter_longevity', maxPoints: 3, row: 3, col: 3, desc: ["Reduces the cooldown of your Bestial Wrath, Intimidation, and pet special abilities by 10%.", "20%", "30%"] },
    // Tier 5
    ...
    { id: 'ferocious_inspiration', name: 'Ferocious Inspiration', icon: 'ability_hunter_ferociousinspiration', maxPoints: 3, row: 4, col: 2, desc: ["When your pet scores a critical hit, all party members have all damage increased by 1% for 10 seconds.", "2%", "3%"] },
    { id: 'spirit_bond', name: 'Spirit Bond', icon: 'ability_druid_demoralizingroar', maxPoints: 2, row: 4, col: 0, desc: ["While your pet is active, you and your pet regenerate 1% of total health every 10 seconds.", "2%"] },
    // Tier 6
...
exports.HUNTER_MM_TALENTS = [
    // Tier 1
    { id: 'efficiency', name: 'Efficiency', icon: 'spell_frost_wizardmark', maxPoints: 3, row: 0, col: 1, desc: ["Reduces the Focus cost of your Shots and Stings by 3%.", "6%", "10%"] },
    { id: 'lethal_shots', name: 'Lethal Shots', icon: 'ability_searingarrow', maxPoints: 5, row: 0, col: 2, desc: ["Increases your critical strike chance with ranged weapons by 1%.", "2%", "3%", "4%", "5%"] },
    { id: 'imp_hunters_mark', name: "Improved Hunter's Mark", icon: 'ability_hunter_snipershot', maxPoints: 2, row: 0, col: 0, desc: ["Causes 50% of your Hunter's Mark ability's base ranged attack power to apply to melee attack power as well.", "100%"] },
    // Tier 2
    { id: 'go_for_the_throat', name: 'Go for the Throat', icon: 'ability_hunter_goforthethroat', maxPoints: 3, row: 1, col: 0, desc: ["Your ranged critical hits cause your pet to generate 8 Focus.", "16 Focus", "25 Focus"] },
    { id: 'hawk_eye', name: 'Hawk Eye', icon: 'ability_townwatch', maxPoints: 3, row: 1, col: 1, desc: ["Increases the range of your ranged weapons by 2 yards.", "4 yards.", "6 yards."] },
    { id: 'rapid_killing', name: 'Rapid Killing', icon: 'ability_hunter_rapidkilling', maxPoints: 2, row: 1, col: 2, desc: ["Reduces the cooldown of your Rapid Fire ability by 1 minute.", "2 minutes"] },
    ...
    // Tier 3
    { id: 'imp_stings', name: 'Improved Stings', icon: 'ability_hunter_snipershot', maxPoints: 3, row: 2, col: 0, desc: ["Increases the damage done by your Serpent Sting by 10% and reduces the Focus cost of all Stings by 10%.", "20% / 20%", "30% / 30%"] },
    ...
    // Tier 4
    { id: 'barrage', name: 'Barrage', icon: 'ability_upgrademoonglaive', maxPoints: 3, row: 3, col: 1, desc: ["Increases the damage done by your Multi-Shot and Volley spells by 5%.", "10%", "15%"] },
    ...
    // Tier 6
    { id: 'piercing_shots', name: 'Piercing Shots', icon: 'ability_hunter_piercingshots', maxPoints: 3, row: 5, col: 0, desc: ["Your critical strikes with Aimed Shot, Steady Shot, and Chimera Shot cause the target to bleed for 10% of the damage dealt over 8 seconds.", "20%", "30%"] },
    { id: 'sniper_training', name: 'Sniper Training', icon: 'ability_hunter_snipertraining', maxPoints: 2, row: 5, col: 1, requires: { id: 'trueshot_aura', points: 1 }, desc: ["When you stand still for 6 seconds, you gain a 3% damage increase to your ranged attacks. Effect lasts 15 seconds or until you move.", "6%"] },
    { id: 'marked_for_death', name: 'Marked for Death', icon: 'ability_hunter_markedfordeath', maxPoints: 2, row: 5, col: 2, desc: ["Increases the damage you deal to targets afflicted by your Hunter's Mark by 2%.", "4%"] },
    // Tier 7
    { id: 'chimera_shot', name: 'Chimera Shot', icon: 'ability_hunter_chimerashot2', maxPoints: 1, row: 6, col: 1, requires: { id: 'sniper_training', points: 2 }, desc: ["You deal 125% weapon damage, refreshing the current Sting on your target and triggering an effect: Serpent Sting - Instantly deals 40% of the Sting's total damage. Viper Sting - Instantly restores 15 Focus. Scorpid Sting - Attempts to Disarm the target for 10 sec. 10 second cooldown."] }
];
exports.HUNTER_SURVIVAL_TALENTS = [
    // Tier 1
    { id: 'savage_strikes', name: 'Savage Strikes', icon: 'ability_racial_bloodrage', maxPoints: 3, row: 0, col: 1, desc: ["Increases the critical strike chance of your Raptor Strike and Mongoose Bite by 10%.", "20%", "30%"] },
    { id: 'deflection', name: 'Deflection', icon: 'ability_parry', maxPoints: 5, row: 0, col: 2, desc: ["Increases your chance to Parry by 1%, and reduces the duration of all movement impairing effects on you by 4%.", "2% / 8%", "3% / 12%", "4% / 16%", "5% / 20%"] },
    { id: 'imp_tracking', name: 'Improved Tracking', icon: 'ability_hunter_pathfinding', maxPoints: 2, row: 0, col: 0, desc: ["Increases all damage caused to targets that are being tracked by 2%.", "4%"] },
    // Tier 2
    { id: 'clever_traps', name: 'Clever Traps', icon: 'spell_nature_timestop', maxPoints: 3, row: 1, col: 0, desc: ["Increases the damage of your Immolation and Explosive Traps by 10%, and the duration of your Freezing and Frost Traps by 10%.", "20% / 20%", "30% / 30%"] },
    { id: 'survivalist', name: 'Survivalist', icon: 'spell_shadow_twilight', maxPoints: 3, row: 1, col: 1, desc: ["Increases your total Health by 3%.", "6%", "10%"] },
    { id: 'entrapment', name: 'Entrapment', icon: 'spell_nature_stranglevines', maxPoints: 2, row: 1, col: 2, desc: ["Gives your Immolation Trap, Frost Trap, and Explosive Trap a 13% chance to entrap the target, preventing them from moving for 4 seconds.", "25%"] },
    { id: 'surefooted', name: 'Surefooted', icon: 'ability_kick', maxPoints: 2, row: 1, col: 3, desc: ["Increases your hit chance by 1% and increases your resistance to movement impairing effects by an additional 10%.", "2% / 20%"] },
    // Tier 3
    { id: 'scatter_shot', name: 'Scatter Shot', icon: 'ability_golemstormbolt', maxPoints: 1, row: 2, col: 1, requires: { id: 'survivalist', points: 3 }, desc: ["A short-range shot that deals 50% weapon damage and disorients the target for 4 seconds. Any damage caused will remove the effect. Turns off your attack when used. 30 second cooldown."] },
    { id: 'survival_instincts', name: 'Survival Instincts', icon: 'ability_hunter_survivalinstincts', maxPoints: 5, row: 2, col: 0, desc: ["Reduces all damage taken by 1% and increases your Attack Power by 1%.", "2% / 2%", "3% / 3%", "4% / 4%", "5% / 5%"] },
    ...
    // Tier 5
    { id: 'wyvern_sting', name: 'Wyvern Sting', icon: 'inv_spear_02', maxPoints: 1, row: 4, col: 1, requires: { id: 'killer_instinct', points: 3 }, desc: ["A stinging shot that puts the target to sleep for 12 seconds. Any damage will cancel the effect. Cuando the target wakes up, the Sting causes Nature damage over 12 seconds. 1 minute cooldown."] },
    { id: 'lightning_reflexes', name: 'Lightning Reflexes', icon: 'spell_nature_invisibilty', maxPoints: 3, row: 4, col: 2, desc: ["Increases your total Agility by 5%.", "10%", "15%"] },
    { id: 'resourcefulness', name: 'Resourcefulness', icon: 'ability_hunter_resourcefulness', maxPoints: 2, row: 4, col: 0, desc: ["Reduces the Focus cost of all traps and melee abilities by 10%.", "20%"] },
    // Tier 6
    ...
    { id: 'noxious_stings', name: 'Noxious Stings', icon: 'spell_nature_corrosivebreath', maxPoints: 3, row: 5, col: 3, desc: ["Increases all damage done to targets afflicted by your Wyvern Sting or Serpent Sting by 1%.", "2%", "3%"] },
    // Tier 7

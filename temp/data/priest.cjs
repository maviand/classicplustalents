...
exports.CHANGELOG = exports.PRIEST_SHADOW_TALENTS = exports.PRIEST_HOLY_TALENTS = exports.PRIEST_DISC_TALENTS = void 0;
exports.PRIEST_DISC_TALENTS = [
    // Tier 1
...
exports.PRIEST_SHADOW_TALENTS = [
    ...
    // Tier 4
    { id: 'shadow_reach', name: 'Shadow Reach', icon: 'spell_shadow_chilltouch', maxPoints: 2, row: 3, col: 0, desc: ["Increases the range of your offensive Shadow spells by 10% and reduces the threat generated by your Shadow spells by 10%.", "20% / 20%"] },

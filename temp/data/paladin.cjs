...
exports.CHANGELOG = exports.PROTECTION_TALENTS = exports.HOLY_TALENTS = exports.RETRIBUTION_TALENTS = void 0;
exports.RETRIBUTION_TALENTS = [
    // TIER 1
    {
        id: 'imp_judgement', name: 'Improved Judgement', icon: 'spell_holy_righteousfury', maxPoints: 2, row: 0, col: 0,
        desc: ["Decreases the cooldown of your Judgement spell by 1 sec.", "2"
        ]
    },
    {
        id: 'imp_bom', name: 'Improved Blessing of Might', icon: 'spell_holy_fistofjustice', maxPoints: 3, row: 0, col: 1,
        desc: ["Increases the melee attack power bonus of your Blessing of Might by 5%.", "10", "15"
        ]
    },
    {
        id: 'divine_strength', name: 'Divine Strength', icon: 'spell_nature_strength', maxPoints: 5, row: 0, col: 2,
        desc: ["Increases your Strength by 2%.", "4", "6", "8", "10"
        ]
    },
    // TIER 2
    {
        id: 'zealous_momentum', name: 'Zealous Momentum', icon: 'spell_holy_prayerofhealing02', maxPoints: 2, row: 1, col: 0,
        desc: ["After casting any Judgement, your movement speed is increased by 15% for 3 seconds, and you gain 15% resistance to slow effects for the duration.", "30 / 30"]
    },
    {
        id: 'imp_sotc', name: 'Improved Seal of the Crusader', icon: 'spell_holy_holysmite', maxPoints: 3, row: 1, col: 1,
        desc: ["Increases the melee attack power bonus of your Seal of the Crusader and the Holy damage increase of your Judgement by 10%. In addition, your Holy spells have a 1% increased critical strike chance against targets afflicted by your Judgement of the Crusader.", "20 / 2", "30 / 3"]
    },
    {
        id: 'deflection', name: 'Deflection', icon: 'ability_parry', maxPoints: 5, row: 1, col: 2,
        desc: ["Increases your Parry chance by 1%. After parrying an attack, your next melee swing deals an additional 2% damage as Holy.", "2 / 4", "3 / 6", "4 / 8", "5 / 10"]
    },
    // TIER 3
    {
        id: 'vindication', name: 'Vindication', icon: 'spell_holy_vindication', maxPoints: 3, row: 2, col: 0,
        desc: ["Your melee attacks have a chance to reduce the target's Attack Power and Spell Damage by 5% for 10 sec.", "10", "15"
        ]
    },
    {
        id: 'conviction', name: 'Conviction', icon: 'spell_holy_retributionaura', maxPoints: 5, row: 2, col: 1,
        desc: ["Increases your chance to get a critical strike with melee weapons by 1%.", "2", "3", "4", "5"
        ]
    },
    {
        id: 'soc', name: 'Seal of Command', icon: 'ability_warrior_innerrage', maxPoints: 1, row: 2, col: 2,
        desc: [
    ...
    {
        id: 'poj', name: 'Pursuit of Justice', icon: 'spell_holy_persuitofjustice', maxPoints: 2, row: 2, col: 3,
        desc: ["Increases movement and mounted movement speed by 4%. Reduces the duration of all Root and Snare effects on you by 10%. This does not stack with other movement speed increasing effects.", "8 / 20"]
    },
    // TIER 4
    {
        id: 'eye_for_an_eye', name: 'Eye for an Eye', icon: 'spell_holy_eyeforaneye', maxPoints: 2, row: 3, col: 0,
        desc: ["All spell criticals against you cause 15% of the damage taken to the caster as well. The damage caused by Eye for an Eye will not exceed 50% of the Paladin's total health.", "30"
        ]
    },
    {
    ...
    {
        id: 'two_handed_spec', name: 'Two-Handed Weapon Specialization', icon: 'inv_hammer_04', maxPoints: 3, row: 3, col: 3,
        desc: ["Increases the damage you deal with two-handed melee weapons by 2%.", "4", "6"
        ]
    },
    // TIER 5
    {
        id: 'crusader_strike', name: 'Crusader Strike', icon: 'spell_holy_crusaderstrike', maxPoints: 1, row: 4, col: 0,
        desc: [
            "An instant strike that causes 110% of your weapon damage and refreshes all Judgements on the target."
        ]
    },
    {
        id: 'sanctity_aura', name: 'Sanctity Aura', icon: 'spell_holy_mindvision', maxPoints: 1, row: 4, col: 2,
        desc: [
    ...
    {
        id: 'imp_sanctity_aura', name: 'Improved Sanctity Aura', icon: 'spell_holy_mindvision', maxPoints: 2, row: 4, col: 3,
        requires: { id: 'sanctity_aura', points: 1 },
        desc: ["The amount of damage caused by targets affected by Sanctity Aura is increased by 1%.", "2"
        ]
    },
    // TIER 6
    {
        id: 'vengeance', name: 'Vengeance', icon: 'spell_nature_purge', maxPoints: 5, row: 5, col: 1,
        requires: { id: 'conviction', points: 5 },
...
exports.HOLY_TALENTS = [
    // TIER 1
    {
        id: 'spiritual_focus', name: 'Spiritual Focus', icon: 'spell_arcane_blink', maxPoints: 2, row: 0, col: 0,
        desc: ["Gives your Flash of Light and Holy Light spells a 35% chance to not lose casting time when you take damage.", "70"
        ]
    },
    {
        id: 'benediction', name: 'Benediction', icon: 'spell_frost_windwalkon', maxPoints: 3, row: 0, col: 1,
        desc: ["Reduces the mana cost of your Judgement and Seal spells by 5%.", "10", "15"
        ]
    },
    {
        id: 'divine_intellect', name: 'Divine Intellect', icon: 'spell_nature_sleep', maxPoints: 5, row: 0, col: 2,
    ...
    {
        id: 'imp_sor', name: 'Improved Seal of Righteousness', icon: 'ability_thunderbolt', maxPoints: 5, row: 1, col: 2,
        desc: ["Increases the damage done by your Seal of Righteousness and Judgement of Righteousness by 3%. In addition, your Judgement of Righteousness increases the Holy damage the target takes by 2% for 10 sec.", "6 / 4", "9 / 6", "12 / 8", "15 / 10"]
    },
    // TIER 3
    {
        id: 'healing_light', name: 'Healing Light', icon: 'spell_holy_holybolt', maxPoints: 3, row: 2, col: 0,
        desc: ["Increases the amount healed by your Holy Light, Flash of Light, and Holy Shock spells by 4%.", "8", "12"
        ]
    },
    {
        id: 'aura_mastery', name: 'Aura Mastery', icon: 'spell_holy_auramastery', maxPoints: 1, row: 2, col: 1,
        desc: [
    ...
    {
        id: 'imp_loh', name: 'Improved Lay on Hands', icon: 'spell_holy_layonhands', maxPoints: 2, row: 2, col: 2,
        desc: ["Gives the target of your Lay on Hands spell a 15% bonus to their armor value from items for 2 min. In addition, the cooldown for your Lay on Hands spell is reduced by 10 min.", "30 / 20"]
    },
    {
    ...
    {
        id: 'imp_bow', name: 'Improved Blessing of Wisdom', icon: 'spell_holy_sealofwisdom', maxPoints: 2, row: 3, col: 2,
        desc: ["Increases the effect of your Blessing of Wisdom spell by 10%.", "20"
        ]
    },
    // TIER 5
    {
    ...
    {
        id: 'lasting_judgement', name: 'Lasting Judgement', icon: 'spell_holy_healingaura', maxPoints: 3, row: 4, col: 2,
...
exports.PROTECTION_TALENTS = [
    // TIER 1
    {
        id: 'divinity', name: 'Divinity', icon: 'spell_holy_blindingheal', maxPoints: 2, row: 0, col: 0,
    ...
    {
        id: 'redoubt', name: 'Redoubt', icon: 'ability_defend', maxPoints: 5, row: 0, col: 2,
        desc: ["Increases your chance to block attacks with your shield by 6% after taking a melee attack. Lasts 10 sec or 5 blocks.", "12", "18", "24", "30"
        ]
    },
    // TIER 2
    {
        id: 'toughness', name: 'Toughness', icon: 'spell_holy_devotion', maxPoints: 5, row: 1, col: 3,
        desc: ["Increases your armor value from items by 2%, and reduces the casting time lost when taking melee attacks by 10%.", "4 / 20", "6 / 30", "8 / 40", "10 / 50"]
    },
    {
        id: 'righteous_resolve', name: 'Righteous Resolve', icon: 'spell_holy_righteousfury', maxPoints: 3, row: 1, col: 0,
        desc: ["Reduces the mana cost of your Seals and Judgements by 10%, and blocking an attack has a 33% chance to restore 2% of your base mana.", "20 / 66", "30 / 100"]
    },
    {
        id: 'imp_devotion', name: 'Improved Devotion Aura', icon: 'spell_holy_devotionaura', maxPoints: 2, row: 1, col: 1,
        desc: ["Increases the armor bonus of your Devotion Aura by 10%.", "20"
        ]
    },
    // TIER 3
    {
        id: 'bos', name: 'Blessing of Sanctuary', icon: 'spell_nature_lightningshield', maxPoints: 1, row: 2, col: 1,
        desc: [
    ...
    // TIER 4
    {
        ...
        requires: { id: 'redoubt', points: 5 },
        desc: ["Increases the amount of damage absorbed by your shield by 10% and has a 33% chance to reflect 15% of the blocked damage as Holy damage to the attacker.", "20 / 66", "30 / 100"]
    },
    {
        id: 'guardians_favor', name: "Guardian's Favor", icon: 'spell_holy_sealofprotection', maxPoints: 2, row: 3, col: 0,
        desc: ["Reduces the cooldown of Blessing of Protection by 60 sec, and while Blessing of Freedom is active, the target's movement speed is increased by 10%.", "120 / 20"]
    },
    {
        id: 'imp_rf', name: 'Improved Righteous Fury', icon: 'spell_holy_sealoffury', maxPoints: 3, row: 3, col: 1,
        desc: ["Increases the amount of threat generated by your Righteous Fury spell by 16% and reduces all damage taken while it is active by 2%.", "33 / 4", "50 / 6"]
    },
    // TIER 5
    {
        id: 'holy_shield', name: 'Holy Shield', icon: 'spell_holy_blessingofprotection', maxPoints: 1, row: 4, col: 2,
        requires: { id: 'shield_spec', points: 3 },
        desc: [
    ...
    {
        id: 'reckoning', name: 'Reckoning', icon: 'spell_holy_blessingofstrength', maxPoints: 3, row: 4, col: 1,
        desc: ["Gives you a 4% chance after taking a damaging attack to gain an extra attack.", "7", "10"
        ]
    },
    // TIER 6
    {

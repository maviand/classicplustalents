// Auto-generated by generateWorld.cjs (POLISHED HANDCRAFTED CLASSIC+ EDITION WITH SURAMAR-STYLE CAMPAIGNS)
...
export const zonesData: Record<string, ZoneItem[]> = {
  ...
  [REGIONS.INSURGENCY]: [
  {
    ...
    "hubs": [
      "The Blackwald Under-Vaults",
      "The Merchant Cellars",
      "Crowley's Redoubt"
    ],
    ...
    "description": "A multi-week urban insurgency campaign. The city of Gilneas is under martial quarantine by Forsaken forces and renegade nobility. Players establish an underground resistance base in the sewer networks, use noble disguises to slip past plague-guard patrols, and liberate districts one by one.",
    "majorQuests": [
      "The Fate of The Liberation of Gilneas City",
      "Defense of The Blackwald Under-Vaults",
      "Secrets of The Merchant Cellars"
    ],
    "dungeonsAndRaids": [
      "The Liberation of Gilneas City Dungeon",
      "The Liberation of Gilneas City Lair"
    ],
    "rareSpawns": [
      "Ancient The Stalker",
      "Corrupted Vanguard of The"
  ...
  },
  {
    ...
    "level": "60 (Suramar-Style Narrative Campaign)",
    "hubs": [
      "Trollbane Underground",
      "Sanctuary of Arathor",
      "The Defiant Forge"
    ],
    ...
    "description": "A dense urban reconstruction and espionage campaign inside the ruined fortress-city of Stromgarde in Arathi Highlands. Players operate from concealed subterranean crypts, decoding Syndicate ciphers and reclaiming the ancient district wards.",
    "majorQuests": [
      "The Fate of The Arathor Restoration Campaign",
      "Defense of Trollbane Underground",
      "Secrets of Sanctuary of Arathor"
    ],
    "dungeonsAndRaids": [
      "The Arathor Restoration Campaign Dungeon",
      "The Arathor Restoration Campaign Lair"
    ],
    "rareSpawns": [
      "Ancient The Stalker",
      "Corrupted Vanguard of The"
  ...
  },
  {
    ...
    "level": "60 (Suramar-Style Narrative Campaign)",
    "hubs": [
      "Sub-Vault 7 (Sanctuary)",
      "The Vent Pipe Network",
      "Tinker's Command"
    ],
    ...
    "description": "A deep infiltration campaign inside the contaminated, trogg-occupied underbelly of Gnomeregan. Players set up sealed, decontamination-safe forward workshops in abandoned maintenance pipes, deploying specialized scrubbers and repairing ancient steam golems.",
    "majorQuests": [
      "The Fate of The Cogway Underground Resistance",
      "Defense of Sub-Vault 7 (Sanctuary)",
      "Secrets of The Vent Pipe Network"
    ],
    "dungeonsAndRaids": [
      "The Cogway Underground Resistance Dungeon",
      "The Cogway Underground Resistance Lair"
    ],
    "rareSpawns": [
      "Ancient The Stalker",
      "Corrupted Vanguard of The"

// Auto-generated by generateRaces.cjs (POLISHED CLASSIC+ RACIAL TRAITS EDITION - ALL RACES ≥4 TRAITS)
    ...
    "traits": [
      {
        ...
        "desc": "Reputation gains increased by 10% across all factions."
      },
      {
        "name": "The Human Spirit",
        "icon": "spell_holy_divinespirit",
        "desc": "Spirit increased by 5%, accelerating mana and health regeneration."
      },
      {
        "name": "Perception",
        "icon": "spell_nature_sleep",
        "desc": "Dramatically increases stealth detection against rogues and prowling beasts for 20 sec."
      },
      {
  ...
  },
  {
    ...
    "traits": [
      ...
      },
      {
        ...
        "desc": "Allows the dwarf to sense nearby treasure chests on the minimap."
      },
      {
        "name": "Gun Specialization",
        "icon": "inv_weapon_rifle_01",
        "desc": "Gun skill increased by 5, increasing critical strike chance with rifles."
      },
      {
        "name": "Mountaineer Fortitude",
        "icon": "spell_nature_strength",
        "desc": "Reduces the duration of movement impairing and slow effects by 15%."
      }
    ]
  },
  {
    ...
    "traits": [
      ...
      },
      {
        ...
        "desc": "Transform into a wisp upon death, increasing ghost movement speed by 50%."
      },
      {
        "name": "Quickness",
  ...
  },
  {
    ...
    "traits": [
      ...
      },
      {
        ...
        "desc": "Casting and attack haste increased by 1%, and trap evasion improved."
      }
    ]
  },
  {
    ...
    "traits": [
      {
        ...
        "desc": "Melee and spell critical strike chance increased by 1%."
      },
      {
        "name": "Aberration",
      ...
      },
      {
        "name": "Flayer",
        "icon": "trade_skinning",
        "desc": "Skinning skill increased by 15, and skinning speed is reduced to 1.5 seconds."
      },
      {
        "name": "Claw Mastery",
        "icon": "inv_misc_pelt_04",
        "desc": "Fist and Dagger weapon skill increased by 5."
      }
    ]
  },
  {
    ...
    "traits": [
      {
        ...
        "desc": "Fall damage reduced by 25%, and Nature Resistance increased by 10."
      },
      {
        "name": "Tattooed Hide",
        "icon": "inv_misc_pelt_04",
        "desc": "Armor increased by 3%."
      },
      {
        "name": "Hammer Specialization",
        "icon": "inv_hammer_04",
        "desc": "Two-Handed Mace skill increased by 5."
      },
      {
        "name": "Stormborn",
        "icon": "spell_nature_lightning",
        "desc": "Nature damage dealt increased by 2%."
      }
    ]
  },
  {
    ...
    "traits": [
      ...
      },
      {
        ...
        "desc": "Movement speed in outdoor wilderness zones increased by 5%."
      },
      {
        "name": "Ancestral Resilience",
        "icon": "spell_nature_skinofearth",
        "desc": "Chance to resist stun and forced movement effects increased by 10%."
      },
      {
        "name": "Ursine Claws",
        "icon": "ability_druid_bash",
        "desc": "Fist weapon and Unarmed skill increased by 5, with attacks having a chance to bleed."
      }
    ]
  },
  {
    ...
    "traits": [
      ...
      },
      {
        ...
        "desc": "Bow and Gun skill increased by 5."
      },
      {
        "name": "Silvermoon Heritage",
        "icon": "spell_holy_devotion",
        "desc": "Spell critical strike damage increased by 3%."
      }
    ]
  },
  {
    ...
    "traits": [
      ...
      },
      {
        ...
        "desc": "Damage dealt by Hunter and Warlock pets increased by 5%."
      },
      {
        "name": "Savage Vigor",
        "icon": "spell_nature_bloodlust",
        "desc": "Health regeneration out of combat increased by 20%."
      }
    ]
  },
  {
    ...
    "traits": [
      ...
      },
      {
        ...
        "desc": "Your attacks have a chance to inflict shadow damage and siphon life from the target."
      }
    ]
  },
  {
    ...
    "traits": [
      ...
      },
      {
        ...
        "desc": "Herbalism skill increased by 15, and gathering speed is accelerated."
      },
      {
        "name": "Nature Resistance",
        "icon": "spell_nature_resistnature",
      ...
      {
        "name": "Plainswalker Stride",
        "icon": "spell_nature_spiritwolf",
        "desc": "Out of combat movement speed increased by 5% in outdoor wilderness zones."
      }
    ]
  },
  {
    ...
    "traits": [
      {
        ...
        "desc": "Health regeneration increased by 10%. 10% of total health regeneration continues during combat."
      },
      {
        "name": "Beast Slaying",
    ...
    "traits": [
      {
        "name": "Thick Skull",
        "icon": "spell_nature_strength",
        "desc": "Stun duration reduced by 15%, and total health increased by 3%."
      },
      {
        "name": "Big Appetite",
      ...
      },
      {
        ...
        "desc": "Spell critical strike damage with Arcane and Fire magic increased by 3%."
      }
    ]
  },
  {
    ...
    "traits": [
      {
        ...
        "icon": "spell_nature_skinofearth",
        "desc": "Armor increased by 4%, and Nature Resistance increased by 10."
      },
      {
        "name": "Axe Thrower",
        "icon": "inv_axe_17",
        "desc": "Throwing weapon range increased by 5 yards, and Axe skill increased by 5."
      },
      {
        "name": "Wild Regeneration",
        "icon": "spell_nature_regenerate",
        "desc": "Health regeneration rate increased by 15%."
      },
      {
        "name": "Fierce Vengeance",
        "icon": "spell_shadow_shadetruesight",
        "desc": "Damage dealt against Elves and Humanoid enemies increased by 3%."
      }
    ]
  },
  {
    ...
    "traits": [
      {
        ...
        "desc": "Attack and casting haste increased by 1%."
      },
      {
        "name": "Best Deals Anywhere",
        "icon": "inv_misc_bag_08",
        "desc": "Vendor discount always calculated at maximum Exalted reputation tier (20%)."
      },
      {
        "name": "Better Living Through Chemistry",
        "icon": "trade_alchemy",
        "desc": "Alchemy skill increased by 15."
      },
      {
        "name": "Scavenge & Haggle",
        "icon": "inv_misc_coin_02",
        "desc": "Gold dropped by slain humanoids increased by 10%."
      }
    ]
  },
  {
    ...
    "traits": [
      ...
      },
      {
        ...
        "desc": "Blacksmithing and Mining skill increased by 15."
      },
      {
        "name": "Dungeon Delver",
        "icon": "spell_shadow_shadetruesight",
        "desc": "Movement speed in underground tunnels and caverns increased by 5%."
      },
      {
        "name": "Searing Retribution",
        "icon": "spell_fire_immolation",
        "desc": "When struck in melee, attackers suffer 8 Fire damage."
      }
    ]
  }
];

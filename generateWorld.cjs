...
const tsFile = `// Auto-generated by generateWorld.cjs (POLISHED HANDCRAFTED CLASSIC+ EDITION)
...
console.log('Successfully wrote handcrafted zones.ts with worldZonesData export.');

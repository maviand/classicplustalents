...
let output = '// AUTO-GENERATED WORLD SYSTEMS CONTENT (POLISHED CLASSIC+ EDITION)\n\n';
...
console.log('Successfully wrote polished worldSystemsData.ts without Retail QoL creep');
